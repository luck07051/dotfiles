...
local vcs = function()
  ...
  return table.concat {
    hi('GitSignsAdd'),    '  '..git_info.head,
    hi('GitSignsAdd'),    added,
    hi('GitSignsChange'), changed,
    hi('GitSignsDelete'), removed,
    hi('StatusLine'),
  }
end
...
local diagnostics = function()
  return table.concat {
    hi('DiagnosticError'), diagnostic(' ✗%s', 'Error'),
    hi('DiagnosticWarn'),  diagnostic(' %s', 'Warn'),
    hi('DiagnosticInfo'),  diagnostic(' %s', 'Info'),
    hi('DiagnosticHint'),  diagnostic(' %s', 'Hint'),
    hi('StatusLine'),
  }
end
